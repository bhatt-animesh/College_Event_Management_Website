...
<body>
	<section class="site">
		...
		<section class="portfolio-agileinfo" id="gallery">
			<div class="container">
				<h3 class="heading-agileinfo" data-aos="zoom-in">Recent Updates<span></span></h3>
				<div class="gallery-grids">
					...
					?>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="{!! asset('public/images/gallery/'.$image->profile_image) !!}"
								class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="{!! asset('public/images/gallery/'.$image->profile_image) !!}" class="img-responsive"
									alt="w3ls" />
								<div class="b-wrapper">
		...
		<section class="portfolio-agileinfo" id="gallery">
			<div class="container">
				<h3 class="heading-agileinfo" data-aos="zoom-in">Day - 1<span></span></h3>
				<div class="gallery-grids">
					<div class="tab_img">
		...
		<section class="portfolio-agileinfo" id="gallery">
			<div class="container">
				<h3 class="heading-agileinfo" data-aos="zoom-in">Day - 2<span></span></h3>
				<div class="gallery-grids">
					<div class="tab_img">
		...
		<section class="portfolio-agileinfo" id="gallery">
			<div class="container">
				<h3 class="heading-agileinfo" data-aos="zoom-in">Day - 3<span></span></h3>
				<div class="gallery-grids">
					<div class="tab_img">

					<?php
						foreach ( $gallery_3 as $image) {
					?>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="{!! asset('public/images/gallery/'.$image->profile_image) !!}"
								class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
