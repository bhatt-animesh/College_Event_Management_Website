...
<div class="row page-titles mx-0">
    <div class="col p-md-0">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addBanner" data-whatever="@addBanner">Add Photo</button>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">All Gallery Info</h4>
                    <div class="table-responsive" id="table-display">
                        @include('theme.gallerytable')
                    </div>
                </div>
            </div>
        </div>
...
$(document).ready(function() {
    ...
    $('#add_banner').on('submit', function(event){
        ...
        $.ajax({
            url:"{{ URL::to('admin/Gallery/store') }}",
            method:"POST",
            data:form_data,
            cache: false,
            contentType: false,
    ...
    $('#editbanner').on('submit', function(event){
        ...
        var form_data = new FormData(this);
        $.ajax({
            url:"{{ URL::to('admin/Gallery/update') }}",
            method:'POST',
            data:form_data,
            cache: false,
            contentType: false,
    ...
    function(isConfirm) {
        if (isConfirm) {
            $.ajax({
                ...
                url:"{{ URL::to('admin/Gallery/destroy') }}",
                data: {
                    id: id
                },
                method: 'POST',
